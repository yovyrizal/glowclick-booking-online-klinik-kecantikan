...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <ul>
      <li><a href="dashboard.php"  class="<?= $page==='dashboard.php' ?'active':'' ?>"><i class="fa-solid fa-house"></i> Beranda</a></li>
      <li><a href="booking.php"    class="<?= $page==='booking.php'   ?'active':'' ?>"><i class="fa-solid fa-calendar-plus"></i> Buat Booking</a></li>
      <li><a href="riwayat.php"    class="<?= $page==='riwayat.php'   ?'active':'' ?>"><i class="fa-solid fa-clock-rotate-left"></i> Riwayat Booking</a></li>
    </ul>
    ...
    <ul>
      ...
      <li><a href="../../../index.php"><i class="fa-solid fa-arrow-left"></i> Landing Page</a></li>
    </ul>
  </nav>
...
<div class="main-content">
  <div class="topbar">
    <div class="topbar-left">
      <button class="topbar-toggle" onclick="document.getElementById('sidebar').classList.toggle('open')"><i class="fa-solid fa-bars"></i></button>
